...
namespace PeopleManager.Application.UnitTests.Common.Exceptions;
...
public class ValidationExceptionTests
{
    ...
    {
        var actual = new ValidationException()._errors;
    ...
    public void SingleValidationFailureCreatesASingleElementErrorDictionary()
    {
        ...
        var actual = new ValidationException(failures)._errors;
